...
// season instances, 
const season_instances_url = `${admin_api_url}/_database/_spring_hockey/_coaches/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_spring_hockey/_coaches/league-instances`;
const league_instances_url_params = {};


const conference_instances_url = `${admin_api_url}/_database/_spring_hockey/_coaches/conference-instances`;
const conference_instances_url_params = {};


const division_instances_url = `${admin_api_url}/_database/_spring_hockey/_coaches/division-instances`;
const division_instances_url_params = {};


const team_instances_url = `${admin_api_url}/_database/_spring_hockey/_coaches/team-instances`;
