...
const season_instances_url = `${admin_api_url}/_database/_spring_hockey/_team_instances/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_spring_hockey/_team_instances/league-instances`;
const league_instances_url_params = {};


const conference_instances_url = `${admin_api_url}/_database/_spring_hockey/_team_instances/conference-instances`;
const conference_instances_url_params = {};


const division_instances_url = `${admin_api_url}/_database/_spring_hockey/_team_instances/division-instances`;
...
<Hero title={'Spring Hockey Teams'} />
