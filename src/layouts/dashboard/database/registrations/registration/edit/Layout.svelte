...
const season_instances_url = `${admin_api_url}/_database/_registration/_edit/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_registration/_edit/league-instances`;
const league_instances_url_params = {};


const conference_instances_url = `${admin_api_url}/_database/_registration/_edit/conference-instances`;
const conference_instances_url_params = {};


const division_instances_url = `${admin_api_url}/_database/_registration/_edit/division-instances`;
const division_instances_url_params = {};


const team_instances_url = `${admin_api_url}/_database/_registration/_edit/team-instances`;
const team_instances_url_params = {};


const program_instances_url = `${admin_api_url}/_database/_registration/_edit/program-instances`;
const program_instances_url_params = {};


const camp_instances_url = `${admin_api_url}/_database/_registration/_edit/camp-instances`;
