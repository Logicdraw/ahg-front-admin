...
const season_instances_url = `${admin_api_url}/_database/_adult_hockey/_finances_teams/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_adult_hockey/_finances_teams/league-instances`;
...
<Hero title={'Adult Hockey Team Finances'} />
