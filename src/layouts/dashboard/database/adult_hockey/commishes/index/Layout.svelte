...
const season_instances_url = `${admin_api_url}/_database/_adult_hockey/_commishes/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_adult_hockey/_commishes/league-instances`;
...
<Hero title={'Adult Hockey Commishes'} />
