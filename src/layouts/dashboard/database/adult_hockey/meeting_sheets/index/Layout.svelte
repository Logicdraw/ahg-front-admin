...
const season_instances_url = `${admin_api_url}/_database/_adult_hockey/_free_agents/season-instances`;
const season_instances_url_params = {};


const league_instances_url = `${admin_api_url}/_database/_adult_hockey/_free_agents/league-instances`;
...
<Hero title={'Adult Hockey Meeting Sheets'} />
