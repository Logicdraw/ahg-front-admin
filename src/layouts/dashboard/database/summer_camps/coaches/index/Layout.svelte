...
const camps_url = `${admin_api_url}/_database/_summer_camps/_coaches/camps`;
const camps_url_params = {};


const camp_instances_url = `${admin_api_url}/_database/_summer_camps/_coaches/camp-instances`;
...
<Hero title={'Summer Camps Coaches'} />

<Route {currentRoute} params={{
	...params,
	...{'camps': data[0]},
	...{'camp_instances': data[1]},
}} />
