...
import Tabs from 'components/elements/views/dashboard/other/adult_hockey/finances_teams/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/other/adult_hockey/finances_teams/Filter.svelte';

import Table from 'components/elements/views/dashboard/other/adult_hockey/finances_teams/Table.svelte';
...
async function getRows(url_params) {
	...
	const url = `${admin_api_url}/_other/_adult_hockey/finances-teams?${params_string}`;
