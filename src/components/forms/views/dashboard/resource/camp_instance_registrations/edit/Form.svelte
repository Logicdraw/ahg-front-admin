<script>
export let camp_instance_registration;
...
const {
	...
	initialValues: {
		...
		player_id: camp_instance_registration.player_id || null,

		placed_at_datetime: camp_instance_registration.placed_at_datetime || null,

		comment: camp_instance_registration.comment || null,
		coaches_comment: camp_instance_registration.coaches_comment || null,
		player_submitted_notes: camp_instance_registration.player_submitted_notes || null,

		registration_insurance: camp_instance_registration.registration_insurance || null,

		paid: camp_instance_registration.paid || null,
		total: camp_instance_registration.total || null,
		owes: camp_instance_registration.owes || null,
		discounts: camp_instance_registration.discounts || null,
		discount_names: camp_instance_registration.discount_names || null,
		refunds: camp_instance_registration.refunds || null,
		refund_reason: camp_instance_registration.refund_reason || null,
	},
...
async function submitForm(body_data) {
	...
	const url = `${admin_api_url}/_resources/_registrations/_camp_instance_registration/camp-instance-registrations/${camp_instance_registration.id}`;
