<script>
export let spng_survey_program_instance;
...
const {
	...
	initialValues: {
		name: spng_survey_program_instance.name || null,
		survey_id: spng_survey_program_instance.survey_id || null,
	},
...
async function submitForm(body_data) {
	...
	const url = `${admin_api_url}/_resources/_spng_surveys/spng-survey-program-instances/${spng_survey_program_instance.id}`;
