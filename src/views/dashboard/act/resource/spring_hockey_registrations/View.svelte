...
import ViewForm from 'components/forms/views/dashboard/act/resource/spring_hockey_registrations/view/Form.svelte';
...
async function getACTResourceRow() {
	...
	const url = `${act_api_url}/resources/spring-hockey-registrations/${currentRoute.namedParams.act_resource_row_id}`;
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>ACT Archive: View Spring Hockey Registration</span>
			</p>
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<ViewForm spring_hockey_registration={act_resource_row} />
