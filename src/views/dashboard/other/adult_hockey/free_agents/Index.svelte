...
import Tabs from 'components/elements/views/dashboard/other/adult_hockey/free_agents/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/other/adult_hockey/free_agents/Filter.svelte';

import Table from 'components/elements/views/dashboard/other/adult_hockey/free_agents/Table.svelte';
