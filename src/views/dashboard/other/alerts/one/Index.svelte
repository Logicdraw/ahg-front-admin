...
import Tabs from 'components/elements/views/dashboard/other/alerts/one/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/other/alerts/one/Filter.svelte';

import Table from 'components/elements/views/dashboard/other/alerts/one/Table.svelte';
...
async function getRows(url_params) {
	...
	const url = `${admin_api_url}/_other/_registrations/unique-alerts?${params_string}`;
...
<section class="section skinny-section" style="padding-bottom: 0.5rem !important">
	...
	<div class="container is-fullwidth">
		...
		<Filter bind:url_params season_instances={params['season_instances']} league_instances={params['league_instances']} conference_instances={params['conference_instances']} division_instances={params['division_instances']} team_instances={params['team_instances']} players={params['players']} />
