...
import Tabs from 'components/elements/views/dashboard/other/receipts/index/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/other/receipts/index/Filter.svelte';

import Table from 'components/elements/views/dashboard/other/receipts/index/Table.svelte';
...
async function getRows(params) {
	...
	const url = `${admin_api_url}/_other/_receipts/receipts?${params_string}`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		{#if rows.length === 0}
			...
			<MsgCard msg_show={true} msg_forever={true} msg_type={'error'} msg_text={'No receipts found!'} />
