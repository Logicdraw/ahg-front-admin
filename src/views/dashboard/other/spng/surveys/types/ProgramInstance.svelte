...
import Table from 'components/elements/views/dashboard/other/spng/surveys/program_instance/Table.svelte';

import Filter from 'components/elements/views/dashboard/other/spng/surveys/program_instance/Filter.svelte';
import Tabs from 'components/elements/views/dashboard/other/spng/surveys/program_instance/Tabs.svelte';
...
async function getProgramInstanceSurveys(params) {
	...
	const url = `${admin_api_url}/spng_surveys/program-instance?${params_string}`;
...
$: promise = getProgramInstanceSurveys(params);
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>SportsEngine Program Forms</span>
			</p>
...
<section class="section skinny-section" style="">
	...
	<div class="container is-fullwidth">
		...
		<MsgCard msg_type={'error'} msg_text={'Here are the SportsEngine forms being tracked in our database - pertaining to our <span style="text-decoration: underline;">PROGRAMS</span>'} msg_show={true} />
