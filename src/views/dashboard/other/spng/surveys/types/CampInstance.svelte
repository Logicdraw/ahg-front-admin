...
import Table from 'components/elements/views/dashboard/other/spng/surveys/camp_instance/Table.svelte';

import Filter from 'components/elements/views/dashboard/other/spng/surveys/camp_instance/Filter.svelte';
import Tabs from 'components/elements/views/dashboard/other/spng/surveys/camp_instance/Tabs.svelte';
...
async function getCampInstanceSurveys(params) {
	...
	const url = `${admin_api_url}/spng_surveys/camp-instance?${params_string}`;
...
$: promise = getCampInstanceSurveys(params);
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>SportsEngine Camp Forms</span>
			</p>
...
<section class="section skinny-section" style="">
	...
	<div class="container is-fullwidth">
		...
		<MsgCard msg_type={'error'} msg_text={'Here are the SportsEngine forms being tracked in our database - pertaining to our <span style="text-decoration: underline;">CAMPS</span>'} msg_show={true} />
...
{:then camp_instance_surveys}

<section class="section skinny-section" style="padding-top: 0.25rem !important;">

	<div class="container is-fullwidth">

		{#if camp_instance_surveys.length === 0}

			<MsgCard msg_show={true} msg_forever={true} msg_type={'error'} msg_text={'No Camp Forms found!'} />
