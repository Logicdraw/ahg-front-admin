...
import Table from 'components/elements/views/dashboard/other/spring_hockey/finances/Table.svelte';
...
let url = `${admin_api_url}/_other/_spring_hockey/finances`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		<Filter bind:url_params season_instances={params['season_instances']} league_instances={params['league_instances']} conference_instances={params['conference_instances']} division_instances={params['division_instances']} />
