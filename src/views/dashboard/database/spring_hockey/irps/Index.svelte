...
import Tabs from 'components/elements/views/dashboard/other/spring_hockey/irps/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/other/spring_hockey/irps/Filter.svelte';

import Table from 'components/elements/views/dashboard/other/spring_hockey/irps/Table.svelte';
...
let url = `${admin_api_url}/_other/_spring_hockey/irps`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		{#if rows.length === 0}
			...
			<MsgCard msg_show={true} msg_forever={true} msg_type={'error'} msg_text={'No independently registered players found!'} />
