...
import Tabs from 'components/elements/views/dashboard/database/registrations/list/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/database/registrations/list/Filter.svelte';
...
let url = `${admin_api_url}/_database/_registrations/_list/registrations`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		{#if rows.length === 0}
			...
			<MsgCard msg_show={true} msg_forever={true} msg_type={'error'} msg_text={'No registrations found!'} />
