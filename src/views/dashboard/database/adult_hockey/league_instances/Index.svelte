...
let url = `${admin_api_url}/_database/_adult_hockey/_league_instances/league-instances`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		{#if rows.length === 0}
			...
			<MsgCard msg_show={true} msg_forever={true} msg_type={'error'} msg_text={'No reps found!'} />
