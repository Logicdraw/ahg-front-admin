...
import Tabs from 'components/elements/views/dashboard/database/adult_hockey/free_agents/Tabs.svelte';
import Filter from 'components/elements/views/dashboard/database/adult_hockey/free_agents/Filter.svelte';

import Table from 'components/elements/views/dashboard/database/adult_hockey/free_agents/Table.svelte';
...
let url = `${admin_api_url}/_database/_adult_hockey/_free_agents/free-agents`;
...
<section class="section skinny-section" style="padding-bottom: 0.5rem !important;">
	...
	<div class="container is-fullwidth">
		...
		<Filter bind:url_params={url_params} />
		<!-- {at_last_page}  -->
