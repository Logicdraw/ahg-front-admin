...
import Filter from 'components/elements/views/dashboard/resources/program_instances/Filter.svelte';
...
const resource_id = 'program_instances';
...
async function getRows(params) {
	...
	const url = `${admin_api_url}/resources/program-instances?${params_string}`;
