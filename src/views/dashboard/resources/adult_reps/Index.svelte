...
import Filter from 'components/elements/views/dashboard/resources/adult_reps/Filter.svelte';
...
async function getRows(params) {
	...
	const url = `${admin_api_url}/resources/adult-reps?${params_string}`;
