...
// import Form from 'components/forms/views/dashboard/file_templates';
...
let promise = getFileTemplate();


async function getFileTemplate() {
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>Edit Created File Template</span>
			</p>
	...
	<div class="container">
		...
		<div class="columns is-centered">
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<CreatedUpdated row={file_template} />
