...
import Form from 'components/forms/views/dashboard/resource/players/edit/Form.svelte'

import Tabs from 'components/elements/views/dashboard/resource/players/edit/Tabs.svelte';
...
async function getPlayer() {
	...
	const url = `${admin_api_url}/resources/players/${currentRoute.namedParams.resource_id}`;
...
<section class="section skinny-section">
	...
	<div class="container is-fullwidth">
		...
		<Tabs player_id={currentRoute.namedParams.resource_id} />
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form bind:msg_show={msg_show} bind:msg_type={msg_type} bind:msg_text={msg_text} {player} />
