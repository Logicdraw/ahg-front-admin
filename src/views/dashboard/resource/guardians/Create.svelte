...
import Form from 'components/forms/views/dashboard/resource/guardians/create/Form.svelte'
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form bind:msg_show={msg_show} bind:msg_type={msg_type} bind:msg_text={msg_text} players={results[0]} />
