...
async function getGuardian() {
	...
	const url = `${admin_api_url}/resources/guardians/${currentRoute.namedParams.resource_id}`;
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form bind:msg_show={msg_show} bind:msg_type={msg_type} bind:msg_text={msg_text} guardian={results[0]} players={results[1]} />
