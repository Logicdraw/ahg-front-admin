...
import Form from 'components/forms/views/dashboard/resource/spng_survey_program_instance/edit/Form.svelte';
...
async function getResourceRow() {
	...
	const url = `${admin_api_url}/spng-survey-program-instance/${currentRoute.namedParams.resource_row_id}`;
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>View SportsEngine Programs Form</span>
			</p>
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form spng_survey_program_instance={resource_row} />
