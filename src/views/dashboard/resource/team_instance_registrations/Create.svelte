...
import Form from 'components/forms/views/dashboard/resource/team_instance_registrations/create/Form.svelte'
...
async function getTeamInstances() {
	...
	const url = `${admin_api_url}/resources/team-instances?limit=1000000`;
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>Create new Team Registration</span>
			</p>
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form bind:msg_show={msg_show} bind:msg_type={msg_type} bind:msg_text={msg_text} conference_instances={results[0]} division_instances={results[1]} team_instances={results[2]} players={results[3]} />
