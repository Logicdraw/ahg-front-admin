...
import Form from 'components/forms/views/dashboard/resource/adult_reps/edit/Form.svelte'
...
async function getCoach() {
	...
	const url = `${admin_api_url}/resources/adult-reps/${currentRoute.namedParams.resource_id}`;
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form bind:msg_show={msg_show} bind:msg_type={msg_type} bind:msg_text={msg_text} {adult_rep} />
