...
import Form from 'components/forms/views/dashboard/resource/spng_survey_camp_instance/edit/Form.svelte';
	...
	<div class="hero-body">
		...
		<div class="container">
			...
			<p class="hero-subtitle has-text-centered">
				<span>View SportsEngine Camps Form</span>
			</p>
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form spng_survey_camp_instance={resource_row} />
