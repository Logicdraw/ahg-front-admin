...
import Form from 'components/forms/views/dashboard/resource/camp_instances/edit/Form.svelte';
...
async function getResourceRow() {
	...
	const url = `${admin_api_url}/camp-instances/${currentRoute.namedParams.resource_row_id}`;
			...
			<div class="column is-9-desktop is-12-tablet is-12-mobile">
				...
				<div class="card form-card">
					...
					<div class="card-content">
						...
						<Form camp_instance={resource_row} />
